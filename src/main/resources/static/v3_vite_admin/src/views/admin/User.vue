    ...
    <el-row class="user" :gutter="16">
        ...
        <el-col :sm="24" :md="16" :lg="18">
            <el-card shadow="hover">
                ...
                <el-form class="user_right" :model="userState" :rules="rules" ref="userFormRef" label-width="96px">
                    <el-form-item label="昵称" prop="name">
                        <el-input v-model.trim="userState.name" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="邮箱" prop="title">
                        <el-input v-model.trim="userState.title" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="性别" prop="local">
                        <el-input v-model.trim="userState.local" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="电话" prop="local">
                        <el-input v-model.trim="userState.local" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="地址" prop="local">
                        <el-input v-model.trim="userState.local" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="微信号" prop="local">
                        <el-input v-model.trim="userState.local" clearable></el-input>
                    </el-form-item>
                    <el-form-item>
